//A comment by Ngoc and Quang
//A comment with our name in it!
//////////Hello, we're making a comment - Ngoc & Quang
/*
 * Main.
 */
...
boot(void)
{
	...
	kprintf("Quang Vo & Ngoc Huynh's system version %s (%s #%d)\n", 
		GROUP_VERSION, buildconfig, buildversion);
	kprintf("\n");
	hello(); //added by Quang & Ngoc 
	ram_bootstrap();
	scheduler_bootstrap();
	thread_bootstrap();
	vfs_bootstrap();
